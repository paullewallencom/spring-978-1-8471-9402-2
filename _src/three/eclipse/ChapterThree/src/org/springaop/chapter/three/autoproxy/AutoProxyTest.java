...
public class AutoProxyTest {
    ...
    public static void main(String[] args) {
        ...
        StringBuilder sb = new StringBuilder("tiger.hasHotBlood():").append(tiger.hasHotBlood()).append("\n").append("tiger.getNumberPaws():").append(tiger.getNumberPaws()).append("\n");
        System.out.println(sb.toString());

        Bird albatross = (Bird) ctx.getBean("albatross");
        StringBuilder sbTwo = new StringBuilder("albatross.hasBeak():").append(albatross.hasBeak()).append("\n").append("albatross.getNumberPaws():").append(albatross.getNumberPaws());
